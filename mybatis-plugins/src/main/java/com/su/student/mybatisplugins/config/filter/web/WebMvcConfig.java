...
import com.su.student.mybatisplugins.json.deserializer.MyEnumDeserializer;
import com.su.student.mybatisplugins.json.serializer.MyEnumSerializer;
...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    public void configureMessageConverters(List<HttpMessageConverter<?>> converters) {
        ...
        // 配置枚举序列化
        simpleModule.addSerializer(BaseEnum.class,new MyEnumSerializer());
